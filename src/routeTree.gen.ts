...
import { Route as EmployeeLayoutUsersIndexImport } from './routes/_employee-layout/users/index'
...
const EmployeeLayoutUsersIndexRoute = EmployeeLayoutUsersIndexImport.update({
  path: '/users/',
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_employee-layout/users/': {
      id: '/_employee-layout/users/'
      path: '/users'
      fullPath: '/users'
      preLoaderRoute: typeof EmployeeLayoutUsersIndexImport
      parentRoute: typeof EmployeeLayoutImport
    }
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/_employee-layout/users/": {
      "filePath": "_employee-layout/users/index.tsx",
      "parent": "/_employee-layout"
    },
    "/_main-layout/my-applications/": {
